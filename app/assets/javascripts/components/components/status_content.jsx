...
import codeblockify from '../codeblock';
...
class StatusContent extends React.PureComponent {
  ...
  render () {
    ...
    const content = { __html: emojify(codeblockify(status.get('content'))) };
    const spoilerContent = { __html: emojify(codeblockify(escapeTextContentForBrowser(status.get('spoiler_text', '')))) };
